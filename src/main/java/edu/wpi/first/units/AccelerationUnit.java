 ...
 *
 * <p>
 * <strong>NOTE:</strong> This type is not compatible with unit-specific
 * accelerations like
 * {@link edu.wpi.first.units.measure.LinearAcceleration}. Authors of APIs that
 * need to interact
 * with all types should consider using a generic
 * {@code Measure<? extends PerUnit<? extends
 * PerUnit<[dimension>], TimeUnit>, TimeUnit>}. Bounded wildcards are necessary
 * in order to
 * interoperate with <i>any</i> subclass of the
 * {@link edu.wpi.first.units.measure.Per} measurement
 * type.
 *
...
public final class AccelerationUnit<D extends Unit> extends PerUnit<VelocityUnit<D>, TimeUnit> {
  ...
  private static final CombinatoryUnitCache<VelocityUnit, TimeUnit, AccelerationUnit> cache = new CombinatoryUnitCache<>(
      AccelerationUnit::new);
   ...
   *
   * @param magnitude the magnitude of the measurement in terms of the other time
   *                  unit
